...
/* Task 2: There is a typo in your dataset 😱 The 9th artist, Vincent Van Gogh is 
currently Vincent Van Dough. Use an array method to fix this issue and console.log() 
to check your work. */

function fix(array, index, name){
  array[index].name = name;
  return array;
}
console.log(fix(artists, 8, 'Vincent Van Gogh'));
 ...
 * browser will continuously remove artists from the array until there are none left. 
...
and add it to the artists array. Then, add a 21st artist to the array (you) with custom 
information!👩‍🎨👨‍🎨
...
function addArtist(array,id, name, years,genre,nationality, bio){
  ...
  } console.log(addArtist(artists, 21 ,'Amear','1948 - 2085','Web Design','African','Lorem ipsum') );
